...
eeprom signed int e_set_latit = 2650,e_set_longitude =7380,e_low_angle=500,e_high_angle=1250,e_time_interval=15,e_set_timezone=550;
...
void Read_RawValue()
{
	...
	Acc_x = (((int)i2c_read(1)<<8) | (int)i2c_read(1));
	Acc_y = (((int)i2c_read(1)<<8) | (int)i2c_read(1));
	Acc_z = (((int)i2c_read(1)<<8) | (int)i2c_read(1));
	Temperature = (((long)i2c_read(1)<<8) | (long)i2c_read(1));
	Gyro_x = (((long)i2c_read(1)<<8) | (long)i2c_read(1));
	Gyro_y = (((long)i2c_read(1)<<8) | (long)i2c_read(1));
	Gyro_z = (((long)i2c_read(1)<<8) | (long)i2c_read(0));
	i2c_stop();
}
...
//                lcd_putsf("Degs.");
         ...
         lcd_gotoxy(0,2);
                lcd_putsf("X axis: ");
                put_message(Acc_x/16.384);          
                lcd_gotoxy(0,3);
                lcd_putsf("Y-axis: ");       
                put_message(Acc_y/16.384);
                lcd_putsf("  T:");
                put_message((Temperature/340.00)+36.53);
...
// State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=1 
...
// State: Bit7=1 Bit6=P Bit5=0 Bit4=0 Bit3=0 Bit2=P Bit1=P Bit0=P 
PORTD=(1<<PORTD7) | (1<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (0<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
