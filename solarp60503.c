...
int mpu6050_read(void)
{
 // unsigned int buffer2,buffer3;
    ...
    i2c_start();
    i2c_write(0xD3);                            /* I2C start with device read address */
    Gyrox= (((int)i2c_read(1)<<8) | (int)i2c_read(1));
    Gyroy= (((int)i2c_read(1)<<8) | (int)i2c_read(1));
    Gyroz= (((int)i2c_read(1)<<8) | (int)i2c_read(0));
    i2c_stop();
...
pitch =900.0 + 1800.0 * atan ((long)y_angle/sqrt((long)x_angle*(long)x_angle + (long)z_angle*(long)z_angle))/3.141592;
...
*/
        ...
        delay_ms(100);
        angle_filt[1] = mpu6050_read();
        delay_ms(100);
        angle_filt[2] = mpu6050_read();
        delay_ms(100);
        angle_filt[3] = mpu6050_read();
