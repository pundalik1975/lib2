...
/*****************************************************
derived from solarp605011.c
reason: tp add span in angle calculation


derived from solarp60508.c
reason: to add another PWM check mode.
if inc and dec keys are pressed together during power up, go to this mode,
here increase PWM gradually in forward direction,pause for 5 seconds and decrease gradually in reverse.
...
eeprom unsigned char e_hour=12,e_minute=0,e_second=0,e_week=1,e_month=3,e_day=30,e_year=22;
...
eeprom int e_set_width =100,e_set_distance = 170;
...
//       offset = zero_adc;
        ...
        angle = ((angle_filt[0] - zero_adc) * 900)/span_adc;   
...
////////////////////////////////////////////////////////////////////
 ...
 // factory setting for inclinometer and pv/current input calibration.
   ...
   if(calibfact)
    ...
    lcd_gotoxy(0,1);
    lcd_putsf("angle: ");
    angle = (adc_buffer - zero_adc) *900/span_adc;
    display_angle(angle);
    }
