...
modification: to change the timeout limit from existing 2~25 seconds to 2 minutes
timeout_cnt value limit modified in 2 places.
...
/////////////////////////////////////////////////////////////////////                        
 ...
 //               adc_buffer = adc3421_read();
                ...
                relay2=1;
                timeout_cnt++;
                if(timeout_cnt >150000)      //once every 30 seconds
                        {
                        timeout_cnt =0;
