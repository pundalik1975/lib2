...
int x_angle,y_angle,x_angle_old,y_angle_old;
...
int mpu6050_read(void)
{
 // unsigned int buffer2,buffer3;
	...
	y_angle= (((int)i2c_read(1)<<8) | (int)i2c_read(0));
//	buffer3= (((int)i2c_read(1)<<8) | (int)i2c_read(0));
    x_angle = (x_angle + x_angle_old)/2;
    y_angle = (y_angle + y_angle_old)/2;
    x_angle_old = x_angle; 
    y_angle_old = y_angle;       
	i2c_stop();
    return (x_angle + 15000);    
} 
